...
image:weatherfax/weatherfax_icon.png[image]

Retrieves internet image files, reads image files or decodes audio and
then Overlays the image on top of charts.

image:weatherfax/wx-0-retrieve-internet-overlaid-on-chart.png[image]
...
image:weatherfax/wx-2-retrieve-menu.png[image]
...
image:weatherfax/wx-c0-ret-inet-menu-1_0.png[image] +
...
link:weatherfax/weatherfax.-inetpng.png.detail.html[image:weatherfax/weatherfax.-inetpng.png[weatherfax-internet,title="weatherfax-internet",width=400]]
...
image:weatherfax/wx-c1-ret-inet-aviation-americas.png[image] +
Aviation Americas Forecast retrieved via the internet.

image:weatherfax/wx-c2-ret-inet-passsage-atlantic-012wind.png[image] +
Passage Weather Atlantic 012 Wind via internet.

image:weatherfax/wx-c3-ret-inet-bermuda-3day.png[image] +
Bermuda 3 day via internet.

image:weatherfax/wx-c4-ret-inet-noaa-atlantic-24hr-500mb.png[image] +
NOAA Atlantic 24hr 500mb via internet.

image:weatherfax/wx-c5-ret-inet-noaa-atlantic-24hrsurf.png[image] +
NOAA Atlantic 24hr Surface via internet.

image:weatherfax/wx-c6-ret-inet-passage-ne.png[image] +
Passage Weather New England Wind 012

image:weatherfax/wx-c7-ret-inet-passage-novasoctia.png[image] +
Passage Weather Nova Scotia Wind 021

'''''

image:weatherfax/wx-c8-ret-inet-downloaded-list.png[image] +
...
image:weatherfax/wx-b1-ret-hfradiosch-filtertab-menu.png[image]
...
image:weatherfax/wx-a1-ret-audiocapture-recieving.png[image]
...
image:weatherfax/wx-1-file-menu.png[image]
...
image:weatherfax/wx-polarsu1.jpeg[wx-polarsu1.jpg,title="wx-polarsu1.jpg",width=600,height=366]
...
image:weatherfax/wx-overlay.jpeg[wx-overlay.jpg,title="wx-overlay.jpg",width=600,height=353]
...
image:weatherfax/wx-export-open-kap-files.jpeg[wx-export-open-kap-files.jpg,title="wx-export-open-kap-files.jpg",width=601,height=350]

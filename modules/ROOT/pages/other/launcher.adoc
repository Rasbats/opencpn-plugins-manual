...
link:manual/plugins/utility_plugins/launcher_01.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_01.jpeg[image]]
...
link:manual/plugins/utility_plugins/launcher_02.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_02.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_03.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_03.jpeg[image]]
...
link:manual/plugins/utility_plugins/launcher_04.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_04.jpeg[image]] +

and then *Plugins* +

link:manual/plugins/utility_plugins/launcher_05.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_05.jpeg[image]] +

Scroll down untill you see the Launcher-pi. +
 +
Click “*Enable*”. +

link:manual/plugins/utility_plugins/launcher_06.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_06.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_07.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_07.jpeg[image]] +
 +
link:launcher.html#launcher[Back to top of page ↑]
...
link:manual/plugins/utility_plugins/launcher_08.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_08.jpeg[image]] +

Clicking “Preferences” will open the menu “*Launcher Settings*”. +

In the menu “Launcher Settings”, Click “*Add*”. +

link:manual/plugins/utility_plugins/launcher_09.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_09.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_10.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_10.jpeg[image]] +
...
15\root\office15\WINWORD.EXE +
link:manual/plugins/utility_plugins/launcher_11.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_11.jpeg[image]] +
 +
*+++IMPORTANT+++*: *Leave one space after “exe”* and add the *path and
name of the file* you want to open. +
In this case: *C:\MyShip\Manuals\Manual_of_my_ship.docx* +
link:manual/plugins/utility_plugins/launcher_12.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_12.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_13.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_13.jpeg[image]] +

Click “*OK*” to save the Launcher settings. +

link:manual/plugins/utility_plugins/launcher_14.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_14.jpeg[image]] +

Click “*OK*” to exit the “options”-menu and return to the main screen of
OpenCPN. +

link:manual/plugins/utility_plugins/launcher_15.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_15.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_16.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_16.jpeg[image]] +

The WORD-document should open. +

link:manual/plugins/utility_plugins/launcher_17.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_17.jpeg[image]] +
...
link:manual/plugins/utility_plugins/launcher_18.jpg.detail.html[image:manual/plugins/utility_plugins/launcher_18.jpeg[image]] +
 +
